          ...
          >
                      ...
                      <dl className="whitespace-nowrap text-sm font-medium leading-5">
                        ...
                        <dd>
                          {author.twitter && (
                            <Link
                              href={author.twitter}
                              className="text-secondary-700 dark:text-secondary-300 hover:text-secondary-500 dark:hover:text-secondary-400"
                            >
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="prose max-w-none pt-10 pb-8 dark:prose-dark">
                {children}
                <p>Cheers,</p>
                <p className="font-logo text-4xl mt-5">Tati</p>
              </div>
            ...
            <footer>
                  ...
                  <div className="flex justify-between py-4 xl:block xl:space-y-8 xl:py-8">
                    {prev && (
                      <div>
                        ...
                        <div className="text-secondary-700 dark:text-secondary-300 hover:text-secondary-500 dark:hover:text-secondary-400">
              ...
              <div className="pt-4 xl:pt-8">
                <Link
                  href="/blog"
                  className="text-primary-800 dark:text-primary-300 hover:text-primary-600 dark:hover:text-primary-400"
                >
